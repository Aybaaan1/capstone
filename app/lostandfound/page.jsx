...
export default function page(){
    ...
    return (
      ...
      ></section>
      <section className="mt-10 bg-slate-50 flex flex-col items-center justify-center py-10 gap-10">
        <div className="flex items-center justify-end gap-32 w-4/5 px-6">
            <h1 className="font-bold text-5xl">Found Items</h1>
            <button className="bg-primary text-white px-6 py-4 rounded-full text-sm">Report Found Item</button>
        </div>
        ...
        <button className="border-black border px-10 py-3 rounded-full">See All</button>
      </section>
      <section className=" flex flex-col items-center justify-center py-10 gap-20">
        <div className="flex items-center justify-end gap-44 w-4/5 px-6">
            ...
            <button className="bg-primary text-white px-6 py-4 rounded-full text-sm">Report Lost Item</button>
        </div>
        <div className="grid grid-cols-4 place-items-center gap-14">
            {items.map((item) => (
                <Image src={item.path} height={200} width={200}/>
